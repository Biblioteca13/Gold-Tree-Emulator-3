INSERT INTO `texts` (`identifier`, `display_text`) VALUES ('cmd_startquestion_name', 'startquestion');
INSERT INTO `texts` (`identifier`, `display_text`) VALUES ('cmd_lay_name', 'lay');
INSERT INTO `texts` (`identifier`, `display_text`) VALUES ('cmd_handitem_name', 'handitem');
...
INSERT INTO `texts` (`identifier`, `display_text`) VALUES ('cmd_redeempixel_name', 'redeempixel');
INSERT INTO `texts` (`identifier`, `display_text`) VALUES ('cmd_redeemshell_name', 'redeemshell');
...
ALTER TABLE `permissions_ranks` ADD `cmd_lay` ENUM('1', '0') NOT NULL DEFAULT '0';
...
ALTER TABLE `permissions_ranks` ADD `cmd_handitem` ENUM('1', '0') NOT NULL DEFAULT '0';
ALTER TABLE `permissions_ranks` ADD `cmd_vipha` ENUM('1', '0') NOT NULL DEFAULT '0';
ALTER TABLE `permissions_ranks` ADD `cmd_startquestion` ENUM('1', '0') NOT NULL DEFAULT '0';
...
ALTER TABLE `permissions_users` ADD `cmd_lay` ENUM('1', '0') NOT NULL DEFAULT '0';
...
ALTER TABLE `permissions_users` ADD `cmd_handitem` ENUM('1', '0') NOT NULL DEFAULT '0';
ALTER TABLE `permissions_users` ADD `cmd_vipha` ENUM('1', '0') NOT NULL DEFAULT '0';
ALTER TABLE `permissions_users` ADD `cmd_startquestion` ENUM('1', '0') NOT NULL DEFAULT '0';
...
ALTER TABLE `server_settings` ADD `enable_cmd_redeempixels` ENUM('1', '0') NOT NULL DEFAULT '0';
ALTER TABLE `server_settings` ADD `enable_cmd_redeemshells` ENUM('1', '0') NOT NULL DEFAULT '0';
